...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  {
    dirName: "shengsuanyun",
    idHint: "shengsuanyun",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    packageName: "@openclaw/shengsuanyun-provider",
    packageVersion: "2026.3.14",
    packageDescription: "OpenClaw 胜算云模型提供插件",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
      ...
      providerAuthChoices: [
        {
          ...
          cliFlag: "--shengsuanyun-api-key",
          cliOption: "--shengsuanyun-api-key <key>",
          cliDescription: "胜算云 API key",
        },
      ],
    },
  },
