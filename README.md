...
运行环境: **Node 24 (recommended) or Node 22.14+**.
...
- 新手入门: [开始](https://docs.openclaw.ai/start/getting-started), [引导](https://docs.openclaw.ai/start/wizard), [升级](https://docs.openclaw.ai/install/updating)
- 对话频道安装: [Channels index](https://docs.openclaw.ai/channels), [WhatsApp](https://docs.openclaw.ai/channels/whatsapp), [Telegram](https://docs.openclaw.ai/channels/telegram), [Discord](https://docs.openclaw.ai/channels/discord), [Slack](https://docs.openclaw.ai/channels/slack)
...
- 配置 + 安全: [配置](https://docs.openclaw.ai/gateway/configuration), [安全](https://docs.openclaw.ai/gateway/security), [沙盒](https://docs.openclaw.ai/gateway/sandboxing)
- 远程 + 网页: [Gateway](https://docs.openclaw.ai/gateway), [远程登录](https://docs.openclaw.ai/gateway/remote), [Tailscale](https://docs.openclaw.ai/gateway/tailscale), [Web surfaces](https://docs.openclaw.ai/web)
- 工具 + 自动化: [Tools](https://docs.openclaw.ai/tools), [Skills](https://docs.openclaw.ai/tools/skills), [Cron jobs](https://docs.openclaw.ai/automation/cron-jobs), [Webhooks](https://docs.openclaw.ai/automation/webhook), [Gmail Pub/Sub](https://docs.openclaw.ai/automation/gmail-pubsub)
...
- Troubleshooting: [频道排错指南](https://docs.openclaw.ai/channels/troubleshooting), [日志](https://docs.openclaw.ai/logging), [文档](https://docs.openclaw.ai)
