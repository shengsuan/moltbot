 ...
 */
export const qqbotOnboardingAdapter: ChannelSetupWizardAdapter = {
  channel: "qqbot" as any,

  getStatus: async (ctx: ChannelSetupStatusContext): Promise<ChannelSetupStatus> => {
  ...
  configure: async (ctx: ChannelSetupConfigureContext): Promise<ChannelSetupResult> => {
    const cfg = ctx.cfg as OpenClawConfig;
